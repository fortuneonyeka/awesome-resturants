    ...
    <div>
      <div className="rest-conatiner">
        ...
        <div className="rest-details">
          <h3 style={{marginLeft:"50px", marginBottom: "20px"}}>{resturant.toUpperCase()}</h3>
            <ul className="rest-ul">
              <li className="rest-item">Start Time: {start_time}</li>
              <li className="rest-item">End Time:{end_time}</li>
              <li className="rest-item">End Time:{end_time}</li>
            </ul>
        </div>
        </div>
